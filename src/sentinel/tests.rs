...
// ===========================================================================
// Whitelist engine integration tests
// ===========================================================================
//
// These tests verify the whitelist engine working in concert with pre_filter.
// No real RPC calls — fixture-based only.

mod whitelist_integration_tests {
    use bytes::Bytes;
    use ethrex_common::types::{
        BlockHeader, LegacyTransaction, Log, Receipt, Transaction, TxKind, TxType,
    };
